...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark": ""}>
      <Head>
        <title>Vinesh Ramroop Portofolio</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <main className="bg-white px-10 md:px-20 lg:40px dark:bg-gray-900">
        <section className="h-screen">
          <nav className="py-10 mb-12 flex justify-between">
            <h1 className="text-xl">Vinesh</h1>
        ...
        <section>
          ...
          <div className="lg: flex gap-10">
            <div className="text-center shadow-lg p-10 rounded-xl my-10 dark:bg-white">
              ...
              <p className="text-gray-800 py-1">Nextcord</p>
            </div>
          ...
          { /* <div>
            <div className="text-center shadow-lg p-10 rounded-xl my-10">
              ...
              <p className = "py-2">
                Ready to learn AI/Machine Learning algorithms.
              </p>
              <h4 className="text-lg py-4 text-teal-600">Tools I use</h4>
              <p className="text-gray-800 py-1">VS Code</p>
              <p className="text-gray-800 py-1">Python</p>
